...
export const LevelSelect: React.FC<LevelSelectProps> = ({ onSelectLevel }) => {
  return (
    <div className="level-select-container" style={styles.container}>
      <h1 className="level-select-title" style={styles.title}>
        🏰 Tower Defense
      </h1>
      <p className="level-select-subtitle" style={styles.subtitle}>
      ...
      <div className="level-select-grid" style={styles.levelGrid}>
        {LEVELS.map((level) => (
          ...
          >
            <div className="level-select-number" style={styles.levelNumber}>
              {level.level}
            </div>
            <div className="level-select-info" style={styles.levelInfo}>
              ...
              <div className="level-select-waves">
                🌊 {level.waves.length} волн
              </div>
            </div>
          </button>
        ))}
      ...
      <div className="level-select-instructions" style={styles.instructions}>
        <h3
          className="level-select-instructions-title"
          style={styles.instructionsTitle}
        >
          Как играть:
        </h3>
        <ul
          className="level-select-instructions-list"
