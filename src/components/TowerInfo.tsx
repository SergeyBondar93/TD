        ...
        {canUpgrade ? (
          <>
            ...
            <div style={styles.upgradeInfo}>
              {nextUpgradeStats ? (
                <>
                  Урон: {tower.damage.toFixed(1)} →{" "}
                  {nextUpgradeStats.damage.toFixed(1)}
                  <br />
                  Дальность: {tower.range.toFixed(0)} →{" "}
                  {nextUpgradeStats.range.toFixed(0)}
                  <br />
                  Скорость: {tower.fireRate.toFixed(1)} →{" "}
                  {nextUpgradeStats.fireRate.toFixed(1)}
                </>
              ) : null}
            </div>
          </>
